...
# 3. Add DLL Paths to PATH (Targeting Windows 11 / RTX)
...
# 5. Add our source directory AND Isaac Lab to PYTHONPATH (CRITICAL for submodules)
...
Write-Host "--------------------------------------------------"
Write-Host "Launching G1 PLAY REV4 (Visualization)"
Write-Host "--------------------------------------------------"

# Run script (Visual Mode)
python C:\Users\basti\source\repos\mobile-robotics-ws\g1_project\scripts\play_rev4.py
