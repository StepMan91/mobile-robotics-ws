# visualize_rev3_2200.ps1
# Launches the G1 Robot Visualization for Rev3 at 2200 Epochs
...
# 4. Set EXP_PATH for AppLauncher (or SimulationApp fallback)
...
# 6. Run Visualization
Write-Host "--------------------------------------------------"
Write-Host "Launching G1 Visualization (Rev3 2200 Epochs)"
Write-Host "--------------------------------------------------"

$ScriptPath = ".\g1_project\scripts\play_rev3.py"
