...
# 6. Run Visualization
Write-Host "--------------------------------------------------"
Write-Host "Launching G1 VISUALIZATION REV3c (Epoch 2000)"
Write-Host "--------------------------------------------------"

python C:\Users\basti\source\repos\mobile-robotics-ws\g1_project\scripts\play_rev3c.py --num_envs 1 --checkpoint model_2000.pt
