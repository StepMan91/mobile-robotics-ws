...
try:
    ...
    from g1_locomotion.g1_rev3b_env_cfg import G1Rev3bEnvCfg # Config used for Rev3c
...
def main():
    ...
    parser.add_argument("--checkpoint", type=str, default="model_2000.pt") # Epoch 2000
    ...
    ppo_config = {
        ...
        "max_iterations": 3000,
        "experiment_name": "g1_climb_rev3c",
        "run_name": "run_001",
    ...
    # Correct Log Dir for Rev3c
    log_dir = os.path.join(script_dir, "logs_rev3c")
    ...
    # Load Obs Normalization Statistics 
