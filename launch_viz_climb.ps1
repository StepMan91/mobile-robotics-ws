...
# 6. Run Viz
Write-Host "--------------------------------------------------"
Write-Host "Launching G1 CLIMB SETUP VISUALIZATION"
Write-Host "--------------------------------------------------"

python C:\Users\basti\source\repos\mobile-robotics-ws\g1_project\scripts\visualize_climb_setup.py $args
